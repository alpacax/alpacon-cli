...
// SaveStreamAtomic writes r to fileName through a temp file, then renames it
// into place; an existing file keeps its own mode, a new one gets newFilePerm minus the umask.
