...
func TestValidateHostTarget(t *testing.T) {
	tests := []struct {
		...
		{name: "fragment is rejected", host: "alpacon.example.com#frag", wantErr: true},
		{name: "bare fragment separator is rejected", host: "alpacon.example.com#", wantErr: true},
		{name: "port with bare fragment is rejected", host: "alpacon.example.com:8443#", wantErr: true},
